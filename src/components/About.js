    ...
    <div className="w-full bg-black text-white text-center">
      <div className="max-w-[1240px] mx-auto px-4 py-16 ">
        <div>
          ...
          {/*Card Container*/}
          <div className="grid sm:grid-col-2 lg:grid-cols-4 gap-4">
            {/*Card*/}
            ...
            <AboutCard
              ...
              text="Build on a flexible framework that can retrive data from any API,connect with existing systems and integrate with any current or future blockchain."
            />
            <AboutCard
              icon={<SiFsecure size={40} />}
              heading="Proven,ready-made solution"
              text="integrate pre-built,time-tested oracle solutions that already secure tens or billions in smart contract value for market-leading decentralized applications"
            />
            <AboutCard
